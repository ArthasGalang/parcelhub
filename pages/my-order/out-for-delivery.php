...
$cursor = $collection->find([
    ...
    'projection' => ['tracking_no' => 1, 'dateTime' => 1, 'warehouse' => 1]
]);
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                <div class="nav-container">
                    <a class="nav-left" href="order.php">
                ...
                <div class="content">
                    <h1 class="declared-shipment-title">Out for delivery</h1>
                            ...
                            <?php if ($total_declared_shipments > 0): ?>
                                <?php foreach ($shipments as $shipment): ?>
                                    <a class="declared-shipment-card_body"
                                        href="../my-order/details/delivery-details.php?tracking_no=<?php echo htmlspecialchars($shipment['tracking_no']); ?>">
                                        ...
                                        <div class="declared-shipment-list_row">
                                            ...
                                            <span class="declared-shipment-date"><?php echo htmlspecialchars($shipment['dateTime']); ?></span>
                                        </div>
                                    </a>
                                <?php endforeach; ?>
                        </div>
