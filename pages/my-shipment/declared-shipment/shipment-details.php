...
$shipmentDoc = $shipmentCollection->findOne(['user_id' => $user_id, 'tracking_no' => $tracking_no]);
...
$shipment = [
    ...
    'timestamp' => $shipmentDoc['timestamp'],
...
<body>
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                <div class="nav-container">
                    <a class="nav-left" href="../declared-shipment.php">
                        ...
                        <div class="shipment-details-container">
                            <div class="shipment-details-main">
                                <div class="shipment-details-main-header">
                                    ...
                                    <div class="shipment-details-delete_btn" id="deleteShipmentBtn" data-tracking="<?php echo htmlspecialchars($shipment['tracking_no']); ?>">
    ...
    <script>
        document.getElementById('deleteShipmentBtn').addEventListener('click', function() {
            const trackingNo = this.getAttribute('data-tracking');
            if (confirm("Are you sure you want to delete this shipment?")) {
                window.location.href = `../../../database/delete-shipment.php?tracking_no=${trackingNo}`;
            }
        });
    </script>
