    ...
    <section class="dashboard">
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                ...
                <div class="content">
                    <h1 class="manage-order-title">Manage Orders</h1>
                    <div class="manage-order">
                        <div class="manage-order-container">
                            <a class="manage-order-card" href="../pages/my-shipment/shipment.php">
                                <div class="manage-order-card_top">
                                    <div class="manage-order-card_icon" style="background-image: url('../assets/global.png');">
                                    </div>
                                </div>
                                <div class="manage-order-card_bottom">
                                    <div class="manage-order-card_title">
                                        My Shipments
                                    </div>
                                    <div class="manage-order-card_text">
                                        Track your order shipments from warehouses.
                                    </div>
                                </div>
                            </a>
                            <a class="manage-order-card" href="../pages/my-order/order.php">
                                <div class="manage-order-card_top">
                                    <div class="manage-order-card_icon" style="background-image: url('../assets/fast-delivery.png');">
                                    </div>
                                </div>
                                <div class="manage-order-card_bottom">
                                    <div class="manage-order-card_title">
                                    ...
                                    <div class="manage-order-card_text">
                                        Pay delivery fees and history order.
                                    </div>
                                </div>
                            </a>
                        </div>
