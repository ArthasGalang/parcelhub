...
$cursor = $collection->find([
    ...
    'projection' => ['tracking_no' => 1, 'timestamp' => 1, 'warehouse' => 1]
]);
    ...
    <section class="dashboard">
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                ...
                <div class="content">
                    <h1 class="declared-shipment-title">At oversea warehouse</h1>
                            ...
                            <?php if ($total_declared_shipments > 0): ?>
                                <?php foreach ($shipments as $shipment): ?>
                                    <a class="declared-shipment-card_body"
                                        href="../my-shipment/declared-shipment/oversea-shipment-details.php?tracking_no=<?php echo htmlspecialchars($shipment['tracking_no']); ?>">
