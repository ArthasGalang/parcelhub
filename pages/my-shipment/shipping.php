    ...
    <section class="dashboard">
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                ...
                <div class="content">
                    <h1 class="declared-shipment-title">En route to PH warehouse</h1>
                            ...
                            <?php if ($total_declared_shipments > 0): ?>
                                <?php foreach ($shipments as $shipment): ?>
                                    <a class="declared-shipment-card_body"
                                        href="../my-shipment/declared-shipment/shipping.php?tracking_no=<?php echo htmlspecialchars($shipment['tracking_no']); ?>">
