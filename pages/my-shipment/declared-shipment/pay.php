...
<body>
        ...
        <div class="whole-container">
            ...
            <div class="container-main">
                <div class="nav-container">
                    <a class="nav-left" href="../ready-pay.php">
                            ...
                            <div class="shipment-detail-product">
                                <div class="shipment-details-main-header shipment-details-body_item">
                                    ...
                                    <div class="change-address-btn">
                                        <a href="../../delivery.php">Add address</a>
                                    </div>
                                </div>
                                <div class="shipment-details-product_items_container">
                                    <div class="shipment-details-product_items">
                                ...
                                <form method="POST">
                                    <div class="shipment-detail-product">
                                                    ...
                                                    <div class="shipment-details-body-content">
                                                        ...
                                                        <div class="shipment-details-body-content_value">
                                                            <div class="payment-option">
                                                                <input type="radio" id="creditCard" name="paymentMethod" value="Gcash">
                                                                <label for="creditCard">Gcash</label>
                                                            </div>
                                                            <div class="payment-option">
                                                                <input type="radio" id="bankTransfer" name="paymentMethod" value="PayMaya">
                                                                <label for="bankTransfer">PayMaya</label>
                                                            </div>
                                                            <div class="payment-option">
                                        ...
                                        <div class="shipment-details-total_price">
                                            ...
                                            <div class="shipment-details-total_price_value"> ₱ <?php echo number_format($total_shipping_fee); ?> </div>
                                        </div>
                                    </div>
                                    <div class="shipment-details-confirmation">
                                        <button type="submit" class="shipment-details-confirmation_btn" id="confirmPaymentBtn">
                                            <span>CONFIRM</span>
                                        </button>
                                    </div>
                                </form>
    ...
    <script>
        document.getElementById('confirmPaymentBtn').addEventListener('click', function(event) {
            ...
            var addressProvided = <?php echo $default_address ? 'true' : 'false'; ?>;
