        ...
        <div class="bottom-bar">
            <ul class="bottom-bar-nav">
                <li class="bottom-bar-nav-item">
                    <a class="active" href="../pages/dashboard.php">
                        <i class='bx bxs-home'></i>
                        <span>Home</span>
                    </a>
                </li>
                ...
                <div class="content">
                    <div class="account-banner">
                        <div class="account-summary">
                            <span class="account-summary-banner">
                                <div class="account-avatar">
                                    <div class="account-summary-avatar">
                                        <div class="account-summary-avatar_text">
                                            <?php echo htmlspecialchars($user['first_letter']); ?>
                                        </div>
                                    </div>
                                </div>
                                <span class="account-summary-info">
                                    <h6 class="account-summary_info_greetings">
                                        Hello,
                                        <?php echo htmlspecialchars($user['first_name'] . ' ' . $user['last_name']); ?>!
                                    </h6>
                                    <p class="account-summary_info_since">
                                        Member since <?php echo htmlspecialchars($user['member_since']); ?>
                                    </p>
                                </span>
                            </span>
                            <a href="../pages/account.php">
                                <span class="account-summary-edit">
                    ...
                    <div class="latest-content">
                        <img src="../assets/sorting_280.png">
                        <div class="address-list_add">
                            <a class="address-button_add" href="../pages/createOrder.php">
